...
public class DataSpecification implements Specification<ProviderData> {
	private ExtDirectStoreReadRequest req;
	private Environment env;

	public DataSpecification( ExtDirectStoreReadRequest req, Environment env ) {
		this.req = req;
		this.env = env;
	}

	@Override
	public Predicate toPredicate( Root<ProviderData> root, CriteriaQuery<?> query, CriteriaBuilder cb ) {
